    ...
    public static class MusicData
    {
        public static List<MusicalWork> Works { get; } = new()
        {
            ...
            new MusicalWork
            {
                ...
                EnTitle = "Two frases on a theme by O. Kostin",
                UkMeta = "2007",
                EnMeta = "2007"
            },
            ...
            new MusicalWork
            {
                ...
                EnTitle = "«Ой сивая та і зозуленька»",
                UkMeta = "",
                EnMeta = "",
                Links = new()
                {
            ...
            new MusicalWork
            {
                ...
                Links = new()
                {
                    new WorkLink
                    {
                        ...
                        UkText = "ноти",
                        EnText = "score",
                        Url = "https://andrijbondarenko.wordpress.com/wp-content/uploads/2022/03/brzmenia_zrodel.pdf"
                    }
                }
            },
